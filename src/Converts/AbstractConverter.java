...
public abstract class AbstractConverter {
     ...
     *
     * @param category Category that will be shown in the GUI and will be use to
     * sort and select compatible units.
    ...
    /**
     * It receives a value in the chosen measure bases, and transforms it to the
     * chosen measure.
     *
     * @param input User's Input
